...
entity iobusREGFILE_0 is
	port (
		clk             : in  std_logic                     := '0';             --  clock.clk
		rst             : in  std_logic                     := '0';             --       .reset
		mmaddress       : in  std_logic_vector(3 downto 0)  := (others => '0'); --  slave.address
		...
		s_address       : out std_logic_vector(3 downto 0);                     --       .export
		s_read          : out std_logic;                                        --       .export
		s_write         : out std_logic;                                        --       .export
		s_writedata     : out std_logic_vector(31 downto 0)                     --       .export
	);
end entity iobusREGFILE_0;

architecture rtl of iobusREGFILE_0 is
	component MMslaveint is
		...
		port (
			...
			mmaddress       : in  std_logic_vector(3 downto 0)  := (others => 'X'); --  slave.address
...
begin
	...
	iobusregfile_0 : component MMslaveint
		generic map (
			ADDRSIZE => 4
		)
		port map (
...
end architecture rtl; -- of iobusREGFILE_0
