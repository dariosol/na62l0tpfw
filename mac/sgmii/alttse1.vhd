...
-- 			altera_tse_pcs_pma
-- ============================================================
-- Generated by Triple Speed Ethernet 9.1 [Altera, IP Toolbench 1.3.0 Build 222]
-- ************************************************************
...
ARCHITECTURE SYN OF alttse1 IS
...
-- Retrieval info: <MEGACORE title="Triple Speed Ethernet MegaCore Function"  version="9.1"  build="222"  iptb_version="1.3.0 Build 222"  format_version="120" >
...
-- Retrieval info:      <PRIVATE name = "variation_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "project_name" value="system"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "output_name" value="alttse1"  type="STRING"  enable="1" />
...
-- Retrieval info:      <PRIVATE name = "variation_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "instance_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "output_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "filename" value="alttse1.vho"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- Retrieval info:      <PRIVATE name = "output_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "variation_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:      <PRIVATE name = "top_level_name" value="alttse1"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
-- Retrieval info:     <NAMESPACE name = "greybox">
-- Retrieval info:      <PRIVATE name = "filename" value="alttse1_syn.v"  type="STRING"  enable="1" />
-- Retrieval info:     </NAMESPACE>
...
-- =========================================================
-- RELATED_FILES: alttse1.vhd, altera_tse_pcs_pma.v, alttse1_constraints.sdc;
-- IPFS_FILES: alttse1.vho;
-- =========================================================
