...
if [regexp {ModelSim ALTERA} [vsim -version]] {
        ...
        vcom -work stratixiigx_hssi $env(QUARTUS_ROOTDIR)/eda/sim_lib/stratixiigx_hssi_components.vhd
        vcom -work stratixiigx_hssi $env(QUARTUS_ROOTDIR)/eda/sim_lib/stratixiigx_hssi_atoms.vhd

        vlib stratixiv_hssi
        vmap stratixiv_hssi stratixiv_hssi
        vcom -work stratixiV_hssi $env(QUARTUS_ROOTDIR)/eda/sim_lib/stratixiv_hssi_components.vhd
        vcom -work stratixiV_hssi $env(QUARTUS_ROOTDIR)/eda/sim_lib/stratixiv_hssi_atoms.vhd
