...
#  mac
   ...
   if { [ expr ($IS_MAC == 0) && ($IS_PCS == 1) && ($IS_PMA == 1) ] } {
      ...
      #create_clock -period "$TSE_CLOCK_FREQUENCY" -name altera_tse_${REF_CLK}_$TO_THE_VARIATION_NAME [ get_ports  $REF_CLK]
      # Note: ref_clk generated by pll
      create_generated_clock -multiply_by 5 -divide_by 2 -name altera_tse_${REF_CLK}_$TO_THE_VARIATION_NAME -source [get_pins {top1_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|inclk[0]}] [get_pins {top1_inst|PLL|altpll_refclk_inst|altpll_component|auto_generated|pll1|clk[0]}]
      # Note: ref_clk generated by pll
      # (edit)       
   }
