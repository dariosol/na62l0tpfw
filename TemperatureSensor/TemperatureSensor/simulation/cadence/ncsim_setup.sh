...
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/na62torino/altera/16.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/submodules/altera_temp_sense.v" -work temp_sense_0 -cdslib ./cds_libs/temp_sense_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/TemperatureSensor.vhd"                                                                    
fi
