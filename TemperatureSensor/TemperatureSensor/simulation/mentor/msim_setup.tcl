...
# ----------------------------------------
# If TemperatureSensor is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 646 linux 2021.04.29.14:13:13
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "TemperatureSensor"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/home/na62torino/intelFPGA/18.1/quartus/"
}
...
ensure_lib              ./libraries/temp_sense_0/
vmap       temp_sense_0 ./libraries/temp_sense_0/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_temp_sense.v" -work temp_sense_0
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/TemperatureSensor.vhd"                            
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L temp_sense_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L stratixiv_hssi_ver -L stratixiv_pcie_hip_ver -L stratixiv_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L stratixiv_hssi -L stratixiv_pcie_hip -L stratixiv $TOP_LEVEL_NAME
}
